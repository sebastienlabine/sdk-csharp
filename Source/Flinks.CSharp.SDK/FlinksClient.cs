...
namespace Flinks.CSharp.SDK
{
    public class FlinksClient
    {
        ...
        public AuthorizationResult Authorize(string institution, string userName, string password, bool? save, bool? mostRecentCached, bool? withMfaQuestions, RequestLanguage? requestLanguage, bool? scheduleRefresh, string tag = null)
        {
        ...
        /// <returns></returns>
        public AuthorizationResult AnswerMfaQuestionsAndAuthorize(string requestId, List<SecurityChallenge> securityChallenges)
        {
        ...
        /// <returns></returns>
        public AccountSummaryResult GetAccountSummary(string requestId)
        {
        ...
        /// <returns></returns>
        public AccountDetailResult GetAccountDetails(string requestId, bool? withAccountIdentity, bool? withKyc, bool? withTransactions, bool? withBalance, DaysOfTransaction? daysOfTransaction, List<string> accountsFilter = null)
        {
        ...
        /// <returns></returns>
        public StatementResult GetStatements(string requestId, NumberOfStatements? numberOfStatements, List<Guid> accountsFilter)
        {
        ...
        /// <param name="requestId">The requestId generated by the Authorize endpoint request done previously.</param>
        /// <returns></returns>
        public StatementResult GetStatementsAsync(string requestId)
        {
        ...
        /// </summary>
        /// <param name="loginId">The LoginId retrieved from a previous operation (this endpoint doesn't require an Authorize prior to use).</param>
        public DeleteCardResult DeleteCard(string loginId)
        {
