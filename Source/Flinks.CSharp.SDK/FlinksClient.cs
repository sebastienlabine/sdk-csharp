...
namespace Flinks.CSharp.SDK
{
    public class FlinksClient
    {
        ...
        /// <returns>An AuthorizationResponse object contained information regarding the status of the authorization process.</returns>
        public AuthorizationResult Authorize(Guid loginId)
        {
        ...
        public GenerateAuthTokenResult GenerateAuthorizeToken(string secretKey)
        {
            ...
            var apiResponse = JsonConvert.DeserializeObject<GenerateAuthTokenResult>(response.Content);
        ...
        /// <returns>Returns an object containing all the accounts details.</returns>
        public AccountDetailResult GetAccountDetailsAsync(Guid requestId)
        {
            if (!IsClientStatusAuthorized()) throw new Exception($"You can't call GetAccountsSummary when the ClientStatus is not Authorized, you current status is: {ClientStatus}.");
        ...
        private GetStatementsRequestBody GenerateGetStatementsRequestBody(Guid requestId, NumberOfStatements? numberOfStatements, List<Guid> accountsFilter = null)
        {
